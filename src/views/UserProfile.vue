...
<template>
  ...
  >
    <div
      class="md:col-span-3 mb-10 size-40 rounded-full bg-white border-2 border-white mx-auto overflow-hidden"
    >
      <img
        v-if="profile?.avatar"
        :src="profile.avatar"
